...
const page = () => {
  ...
  return (
    <div className="container mx-auto ">
      <h2 className="text-3xl font-bold text-center md:text-start mb-8">
        Add A Pet :{" "}
      </h2>
      <div className=" border-2 md:w-full m-4 md:m-0">
        <form className="p-6 space-y-8 " onSubmit={handlePetFormSubmit}>
